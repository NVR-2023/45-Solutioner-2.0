...
import { LINK_ARRAY_FOOTER } from "./sub-components/linh-array-footer";
  ...
  return (
    <footer className="bg-neutral-400 dark:bg-neutral-700 dark:text-neutral-300">
      <div className="smooth-theme-transition flex flex-col space-y-4 p-4 md:flex-row md:justify-around md:space-y-0">
        <FooterLinksSegment linkList={LINK_ARRAY_FOOTER[0]} />
        <FooterLinksSegment linkList={LINK_ARRAY_FOOTER[1]} />
        <FooterSocialSegment />
      </div>
    </footer>
  );
