...
const Footer: FC = () => {
  ...
  return (
    <footer className="bg-neutral-400 dark:bg-neutral-700 text-black dark:text-white darkModeTransition flex flex-col md:flex-row md:justify-around space-y-3 md:space-y-0 p-4">
