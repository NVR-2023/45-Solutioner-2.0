      ...
      <AnimatePresence>
        {isModalOpen && (
          <motion.dialog
            ...
            variants={variants}
            className="z-50 flex w-[18rem] justify-center rounded bg-[#c9c9c9] px-8 py-5 text-black shadow-[18px_18px_12px_0px_#00000040] backdrop:bg-transparent dark:text-neutral-300"
          >
            {children}
          </motion.dialog>
        )}
