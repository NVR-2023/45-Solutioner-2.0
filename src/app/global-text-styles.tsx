...
export const LIGHT_THEME_FOOTER_LABELS: string =
  LIGHT_THEME_BASE_TEXT + " text-sm font-bold font-small-caps text-sm tracking-wider";
export const DARK_THEME_FOOTER_LABELS: string =
  DARK_THEME_BASE_TEXT + "dark:text-sm dark:font-bold dark:font-small-caps dark:text-sm dark:tracking-wider";

export const LIGHT_THEME_FOOTER_TEXT: string =
  LIGHT_THEME_BASE_TEXT + " font-semibold text-sm tracking-wide";
export const DARK_THEME_FOOTER_TEXT: string =
  DARK_THEME_BASE_TEXT + " dark:font-semibold dark:text-sm dark:tracking-wide";
  
export const LIGHT_THEME_FOOTER_CAPTION: string =
  LIGHT_THEME_BASE_TEXT + " font-semibold text-xs tracking-wide";
export const DARK_THEME_FOOTER_CAPTION: string =
  DARK_THEME_BASE_TEXT + " dark:font-semibold dark:text-xs dark:tracking-wide";


export const LIGHT_THEME_OUTLINED_BUTTON_TEXT: string = "";
export const DARK_THEME_OUTLINED_BUTTON_TEXT: string = "dark:font-bold";

/* font-aperçu font-semibold text-sm text-neutral-500 tracking-wide mb-2
 */
