...
export const LIGHT_THEME_FOOTER_LABELS: string = LIGHT_THEME_BASE_TEXT + " text-sm font-black font-small-caps tracking-wider";
export const DARK_THEME_FOOTER_LABELS: string = DARK_THEME_BASE_TEXT +
  " dark:text-sm dark:font-black dark:font-small-caps dark:tracking-wider";

export const LIGHT_THEME_FOOTER_TEXT: string = LIGHT_THEME_BASE_TEXT + " text-xs font-semibold text-sm";
export const DARK_THEME_FOOTER_TEXT: string = DARK_THEME_BASE_TEXT + " dark:text-xs dark:font-semibold dark:text-sm";

export const LIGHT_THEME_FOOTER_CAPTION: string =
  LIGHT_THEME_BASE_TEXT + " font-semibold text-[0.625rem] tracking-wide";
export const DARK_THEME_FOOTER_CAPTION: string = DARK_THEME_BASE_TEXT + " dark:font-semibold dark:tracking-wide";
